...
export const ThanksMessagePopup = (props: {
  setClicked: IntrinsicAttributes & React.Dispatch<React.SetStateAction<boolean>>;
  post: PostPropsType;
  isOpened: boolean;
    ...
    <>
      <div css={modalContainer}>
        <div css={introWrap}>
          ...
          <div css={category}>
            <img src={switchCategoryImage(props.post.title)} alt='categoryImage' />
            <div className='categoryTitle'>{changeTitleToKo(props.post.title)}</div>
          </div>
        </div>
      </div>
      <div css={modalBg} />
